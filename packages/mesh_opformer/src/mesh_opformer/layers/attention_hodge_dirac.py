...
class MeshMultiHeadHodgeDiracAttention(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(MeshMultiHeadHodgeDiracAttention, self).__init__()
        ...
        self.v_dirac_hodge_ops = (
            MeshMultiHeadHodgeDiracAttentionVertices(**kw) if "v" in modes else None
        )
        self.e_dirac_hodge_ops = (
            MeshMultiHeadHodgeDiracAttentionEdges(**kw) if "e" in modes else None
        )
        self.f_dirac_hodge_ops = (
            MeshMultiHeadHodgeDiracAttentionFaces(**kw) if "f" in modes else None
        )
    ...
    def forward(
        ...
        if "f" in self.modes:
            _x_f = self.f_dirac_hodge_ops(x_e=x_e, d_1=d_1, mask=mask)
        else:
            _x_f = x_f
...
class MeshMultiHeadHodgeDiracAttentionBase(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(MeshMultiHeadHodgeDiracAttentionBase, self).__init__()
...
class MeshMultiHeadHodgeDiracAttentionVertices(MeshMultiHeadHodgeDiracAttentionBase):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(MeshMultiHeadHodgeDiracAttentionVertices, self).__init__(*args, **kwargs)
    ...
    def forward(self, x_v, x_e, d_0, v_idx=None, e_idx=None, mask=None):
        ...
        x_v, self.v_attn = mesh_dirac_attention_v(
            v_Q,
            v_K,
            e_Q,
            e_K,
...
class MeshMultiHeadHodgeDiracAttentionEdges(MeshMultiHeadHodgeDiracAttentionBase):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(MeshMultiHeadHodgeDiracAttentionEdges, self).__init__(*args, **kwargs)
    ...
    def forward(
        ...
        # Apply attention on projected vectors in batch & concat
        x_e, self.e_attn = mesh_dirac_attention_e(
            v_V,
            e_Q,
            e_K,
            f_Q,
...
class MeshMultiHeadHodgeDiracAttentionFaces(MeshMultiHeadHodgeDiracAttentionBase):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(MeshMultiHeadHodgeDiracAttentionFaces, self).__init__(*args, **kwargs)

        self.linear_out = nn.Linear(self.d_f, self.d_f)

    def forward(self, x_e, d_1, mask=None):
        """
        ...
        # Apply attention on projected vectors in batch & concat
        x_f, self.f_attn = mesh_dirac_attention_f(e_V, d_1)
...
def mesh_dirac_attention_f(
    e_V: torch.Tensor, d_1: torch.Tensor
) -> Tuple[torch.Tensor, None]:
    """
    Calculate mesh attention over `m` edges.
